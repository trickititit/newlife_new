        ...
        while ($more) {
            if ($this->IsPrivateOnly) {
                switch ($this->CategoryId) {
                    ...
                    case "23":
                        $link = '/api/9/items?key=' . $this->key . '&sort=default&owner[]=private&withImagesOnly=false&locationId=' . $this->LocationId . '&categoryId=' . $this->CategoryId . '&params[200]=1054&page=' . $page . '&lastStamp=' . $lastStamp . '&display=list&limit=' . $this->Limit;
                        break;
                    case "24":
                        $link = '/api/9/items?key=' . $this->key . '&sort=default&owner[]=private&withImagesOnly=false&locationId=' . $this->LocationId . '&categoryId=' . $this->CategoryId . '&params[201]=1059&page=' . $page . '&lastStamp=' . $lastStamp . '&display=list&limit=' . $this->Limit;
                    break;
                    case "25":
                        $link = '/api/9/items?key=' . $this->key . '&sort=default&owner[]=private&withImagesOnly=false&locationId=' . $this->LocationId . '&categoryId=' . $this->CategoryId . '&params[202]=1064&page=' . $page . '&lastStamp=' . $lastStamp . '&display=list&limit=' . $this->Limit;
                    break;
                    default:
                ...
                $link = '/api/9/items?key=' . $this->key . '&sort=default&withImagesOnly=false&locationId=' . $this->LocationId . '&categoryId=' . $this->CategoryId . '&page=' . $page . '&lastStamp=' . $lastStamp . '&display=list&limit=' . $this->Limit;
    ...
    public function generateObject($initial_data)
    {
        ...
        foreach ($initial_data->item->item->parameters->flat as $parameter) {
            switch ($parameter->title) {
                case "Тип объявления":
                    $obj->deal = $parameter->description;
                    break;
                case "Тип дома":
