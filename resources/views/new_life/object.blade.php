        ...
        <div class="col-md-12">
            <section id="Flexbox" class="Flexbox">
                <article class="BlockLayout BlockLayout--typeFlex" tabindex="0">
                    <div class="row w-100">
                        <a href="#" class="col-md-4 Block Block--item3 Block--isDraggable" title="Click to drag" style="">
                        ...
                        <span class="col-md-4 Block Block--item2">
                        <div class="BlockContent">
                            <h3 class="Heading Heading--size2 text-no-select">two</h3>
                        </div>
                    </span>
                        <a href="#" class="col-md-4 Block Block--item1 Block--isDraggable" title="Click to drag" style="">
                            <div class="BlockContent">
                    ...
                    <div class="row w-100">
                        <a href="#" class="col-md-10 Block Block--item5 Block--isDraggable" title="Click to drag" style="">
                            <div class="BlockContent">
                                <h3 class="Heading Heading--size2 text-no-select">five</h3>
                                <div class="Pattern Pattern--typeHalftone"></div>
                                <div class="Pattern Pattern--typePlaced"></div>
                            </div>
                        </a>
                        <a href="#" class="col-md-2 Block Block--item7 Block--isDraggable" title="Click to drag" style="">
                            <div class="BlockContent">
                                <h3 class="Heading Heading--size2 text-no-select">seven</h3>
                                <div class="Pattern Pattern--typeHalftone"></div>
                                <div class="Pattern Pattern--typePlaced"></div>
                            </div>
                        </a>
                    ...
                    <div class="row w-100">
                        <span class="col-md-6 Block Block--item6">
                        <div class="BlockContent">
                            <h3 class="Heading Heading--size2 text-no-select">six</h3>
                        </div>
                    </span>
                        <a href="#" class="col-md-6 Block Block--item4 Block--isDraggable" title="Click to drag" style="">
                            <div class="BlockContent">
...
<div id="modal-send-telegram" class="iziModal" data-izimodal-title="Связаться">
    <div class="modern-forms">
        <div class="modern-container">
            ...
            <input hidden name="user_id" value="{{$object->createdUser->id}}">
